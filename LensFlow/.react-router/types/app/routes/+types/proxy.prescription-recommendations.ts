...
type Module = typeof import("../proxy.prescription-recommendations.js")

type Info = GetInfo<{
  file: "routes/proxy.prescription-recommendations.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../proxy.prescription-recommendations.js");
}];

import type { PreviewMarketContext, PreviewMoneyFormat } from "../types/cartPreview";
...
function formatNumberByMoneyFormat(value: number, moneyFormat: PreviewMoneyFormat) {
...
export function formatMoney(minor: number, market: PreviewMarketContext) {
...
export function buildFallbackMarket(): PreviewMarketContext {
  return {
    marketId: "default",
    marketName: "Default",
    currencyCode: "USD",

...
export function bundleCartDiscountGenerateRun(
  ...
  const shopOffersPayload = shopAny.offersShop?.jsonValue as
  ...
  if (embedDisabled) {
    ...
    offersPayload = shopOffersPayload ?? null;
    offersSource = shopOffersPayload != null ? "shop_offers" : "no_shop_offers";
  }
